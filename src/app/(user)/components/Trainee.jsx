...
const Trainee = () => {
  ...
  const [showPrev, setShowPersonal] = useState(false);
            ...
            <div className="flex justify-between gap-4">
              <div className="w-1/2">
                ...
                <input
                  ...
                  name="t-name"
                  placeholder="Name"
                  className="t-name w-full rounded-md border border-blue-200 bg-white px-4 py-2 text-gray-500 placeholder-gray-400 focus:border-blue-300 focus:outline-none"
                />
              </div>
              <div className="w-1/2">
                ...
                <input
                  ...
                  name="t-center"
                  placeholder="Name"
                  className="t-center w-full rounded-md border border-blue-200 bg-white px-4 py-2 text-gray-500 placeholder-gray-400 focus:border-blue-300 focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="mt-5 flex justify-between gap-4">
              <div className="w-1/2">
                ...
                <input
                  ...
                  name="t-sdate"
                  placeholder="Date"
                  className="t-sdate w-full rounded-md border border-blue-200 bg-white px-4 py-2 text-gray-500 placeholder-gray-400 focus:border-blue-300 focus:outline-none"
                />
              </div>
              <div className="w-1/2">
                ...
                <input
                  ...
                  name="endDate"
                  placeholder="Date"
                  className="t-edate w-full rounded-md border border-blue-200 bg-white px-4 py-2 text-gray-500 placeholder-gray-400 focus:border-blue-300 focus:outline-none"
                />
              </div>
            </div>
          </div>
